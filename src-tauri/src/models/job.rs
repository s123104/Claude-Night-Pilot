        ...
        let wait_seconds = match self.retry_config.retry_strategy {
            ...
            RetryStrategy::ExponentialBackoff => {
                let backoff = (base_interval as f64 * 
                    self.retry_config.backoff_multiplier.powi(self.failure_count as i32)) as u64;
            ...
            RetryStrategy::Custom(ref intervals) => {
                intervals.get(self.failure_count as usize - 1)
                    .copied()
...
fn default_timeout() -> u64 { 300 } // 5分鐘
fn default_max_parallel() -> u32 { 1 }
fn default_max_retries() -> u32 { 3 }
fn default_retry_interval() -> u64 { 60 } // 1分鐘
fn default_backoff_multiplier() -> f64 { 2.0 }
fn default_max_backoff() -> u64 { 3600 } // 1小時
