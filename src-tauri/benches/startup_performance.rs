use claude_night_pilot_lib::database_manager_impl::{DatabaseConfig, DatabaseManager};
use claude_night_pilot_lib::services::{
    health_service::HealthService, prompt_service::PromptService, sync_service::SyncService,
};
